...
// var exchangeCurrent = 'FTXU'; 
var exchangeCurrent = 'CBSE';
var epsilon2 = 0.0075;
...
var timeFrame = '1Min'; 
var bars_url = 'https://data.alpaca.markets/v1beta1/crypto/'+ cryptoType + '/bars?exchanges='+ exchangeCurrent + '&timeframe='+ timeFrame+ '&start=' + start; 
...
// orders
                ...
                case 'b':
                    ...
                    var timestamp = new Date(bar.t).getTime()/1000;
                        ...
                        if( data[key].x == exchangeCurrent ){ 
                        // if(data[key].x == 'CBSE' ){ //|| data[key].x == exchangeCurrent){
                            currentBar = {
                            time: timestamp, 
                            open: bar.o,
                            high: bar.h,
