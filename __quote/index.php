...
function processJson1($jsonstr) {
    ...
    if ($data && isset($data['data']) && count($data['data']) > 0) {
        ...
        if($json0==0 ) echo $closeprice. $padr.    $datetime. $padr.     $sym. $padr.    $intr. "min". $padr. "EOL";
...
$urlquote="https://api.finazon.io/latest/time_series?dataset=sip_non_pro&ticker=". $sym. "&interval=". $intr. "m&apikey=d4e31787de7446b9aaf281437a981748am";
// echo $urlquote;
