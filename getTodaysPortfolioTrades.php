<?php
// jb    getTodaysPortfolioTrades.php derived from    updatePortfolioTrade.php by John Botti 
...
$prgname= "getTodaysPortfolioTrades.php";
$brokerage="rhood";
...
if( $uuser0=="err"  ||  $insertdb<1 ){   // ==0 or == -10
  ...
  echo "9876543210_". $lastInsertedId. "_". "OKGO" ;
  // echo "0123456789OKGO"; 
}
