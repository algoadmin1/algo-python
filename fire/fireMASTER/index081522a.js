...
// BANNED WORDS: voluptous, infested, bloody, bloodied
//
const aiSentenceGenerator =1;

const words0 = [    "beautiful", "shiny", "ugly", "run down", "disgusting", "average",  "gorgeous",
                    "insane", "peaceful", "evil", "porcelin"
];
const words1 = [  "dark","wet", "gooey", "dusty", "microscopic", "mysterious", "concept art","venomous",
                    "distopian", "ultra detailed","cinematic", "portrait of", "hyper realistic", "hyper realistic painting",
];
const words2 = [    "beautiful woman","warrior","african woman","alien","dog","lion","shark","jack russell", "rhino","dinosaur",
                    "hot girl", "monk", "ninja", "giesha","young girl", "old man", 
                     "beach", "mountains", "sea" , "dreamland", "god",  "godess", "diety",
                    "temple", "cathedral", "hut", "alien outpost", "city streets", "hacker","samurai",
                    "super car","concept car", "archangel"
];
const words3 = [    "cyberpunk", "steampunk", "ancient", "futuristic", "alien", "mech",  "roman","fantasy",
                    "medieval", "matrix", "lovecraft", "pantheon", "ultra realistic", "8k",
                    "neo classic"
];
...
const words99 = [  "pre-raphaelites style", "H.R. Giger style", "salvador dali style", "victorian style", "picasso style", "van gogh style", "michaelangelo style",
                    ...
                    "botticelli style", "botero style", "norman mailer style", "walt whitman style"
];
...
function outputAI(){
    ...
    for(i=0;i<sentenceMax;i++){
        ...
        if(rnd(100)<66) catstr +=  rndword(words99);
         console.log(catstr);
    }
}
