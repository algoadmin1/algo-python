...
function PreCalcCandlesChart( ctx,  vrect , colScheme, wt ){
    ...
    let cnt = 0;     // processedData.length;   /// == NaN ???


    if (processedData && processedData.length) {
        // Safe to use processedData.length here
         cnt = processedData.length;   /// == NaN ???

        console.log("Length:", cnt);
    } else {
        console.log("processedData is null or undefined!");
        console.log("processedData is null or undefined!!");
        console.log("processedData is null or undefined!!!");
        return;
    }
...
function DrawCandlesChart( ctx,  vrect , colScheme, wt ){
    ...
    // PreCal cCandlesChart( ctx,  vrect , colScheme, wt );
