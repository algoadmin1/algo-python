...
class Portfolio:
    ...
    def authenticate(self):
        ...
        login = r.login(self.name ,self.pwd )
  ...
  ## This process is very slow since it is making a GET request for each order.
    ...
    def getOpenPositions(self, stockOrOptions):
        if(stockOrOptions=="stock"):
            ## ???? cal api
            robin_stocks.robinhood.options.get_open_stock_positions(info=None)
...
# dur = gtc, ioc, opg, gfd
    ...
    def findOptions(self):
        ...
        optionData = robin_stocks.find_options_for_list_of_stocks_by_expiration_date(['fb','aapl','tsla','nflx'],expirationDate='2018-11-16',optionType='call')
